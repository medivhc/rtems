...
/*
 * The max number the random renturns
 */
 ...
 * which means random. If start is 0, it will do nothing, else it will call
...
static void print_dev_stats(void)
{
  ...
  rtems_blkstats(stdout, RAMDISK_PATH, false);
}
